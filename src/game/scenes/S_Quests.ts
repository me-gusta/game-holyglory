...
class CardQuest extends BaseNode {
    ...
    constructor(q: Quest, is_purple = false) {
        ...
        this.lbl.anchor.x = 0
        this.icon = create_sprite(reward.icon)
    ...
    resize() {
        ...
        this.icon.position.x = -this.bg.width / 2 + this.icon.width / 2 + 30
        this.lbl.position.x = this.icon.position.x + this.icon.width / 2 + 30
